...
exports.isMobileDevice = exports.setStyle = exports.getPosition = exports.getWidth = exports.menuAllProps = void 0;
...
var getPosition = function getPosition(elem) {
  var rect = elem && typeof elem.getBoundingClientRect === 'function' && elem.getBoundingClientRect();
  return {
    left: rect.left,
    right: rect.right
  };
