...
var DOMWrap = /*#__PURE__*/function (_React$Component) {
  ...
  function DOMWrap() {
    ...
    _this.setChildrenWidthAndResize = function () {
      ...
      var currentDisplayState = menuItemNodesOver.map(item => item.style.display);
      menuItemNodesOver.forEach(item => {
        (0, _util.setStyle)(item, 'display', 'none');
      });
      ...
      _this.menuItemSizes = menuItemNodes.map(function (c) {
        return (0, _util.getPosition)(c);
      });
      _this.ulSizes = (0, _util.getPosition)(ul);
      overflowedItems.forEach(function (c) {
        (0, _util.setStyle)(c, 'display', 'none');
      });
      menuItemNodesOver.forEach((item, index) => item.style.display = currentDisplayState[index]);
      ul.children[ul.children.length - 1].style.display = 'inline-block';
      _this.overflowedIndicatorWidth = (0, _util.getWidth)(ul.children[ul.children.length - 1]);

      if (_this.menuItemSizes.length > 0) {
        _this.originalTotalWidth = _this.menuItemSizes[_this.menuItemSizes.length - 1].right - _this.ulSizes.left;
      }
    ...
    _this.handleResize = function () {
      ...
      ul.setAttribute('style', ul.getAttribute('style') + 'vsibility:' + _this.props.inEntry ? 'visible' : 'hidden' + ';');
      ...
      if (_this.originalTotalWidth > width + FLOAT_PRECISION_ADJUST) {
        ...
        _this.menuItemSizes.forEach(function (liWidth, index) {
          if (index > 0) {
            if (liWidth.left + _this.overflowedIndicatorWidth <= _this.ulSizes.right) {
              lastVisibleIndex += 1;
            }
          }
        });
