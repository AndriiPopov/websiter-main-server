...
export class BigColorPicker extends Component {
    state = {
        isVisible: false
    };
    ...
    render() {
        const { props } = this;
        if (props.sectionValues || props.boxesValues) {
            this.startButtonColor = props.isSection
                ? (!props.withOnCheckbox || props.sectionValues[props.onOffValue]
                    ? props.sectionValues[props.valueKey]
                    : null)
                : (!props.withOnCheckbox || props.boxesValues[props.onOffValue]
                    ? props.boxesValues[props.valueKey]
                    : null);

            this.startControlColor = props.isSection
                ? props.sectionValues[props.valueKey]
                : props.boxesValues[props.valueKey];
        }
                                ...
                                <tr>
                                    <td colSpan="2">
                                        <SketchPicker
                                            ...
                                            onChangeComplete={props.saveToHistory} />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
SmallButton.propTypes = {
    ...
    changedStyleValues: PropTypes.array,
